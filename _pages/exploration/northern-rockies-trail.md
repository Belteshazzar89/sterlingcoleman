...
---
<iframe width="100%" height="500px" frameborder="0" allowfullscreen src="https://caltopo.com/m/F0ARL72"></iframe>
...
The NRT is relatively accessible, given its remoteness. Public transportation is available to Prince George by [plane][yxs]{:target="_blank"}, [train][via-rail]{:target="_blank"}, or [bus][bcbus]{:target="_blank"}. The bus route from Prince George to Fort St. John includes a stop at Azouzetta Lake. As for the Northern Terminus, there are no public transportation options for Liard River, now that bus service has been permanently shut down. Public transportation to Fort Nelson is available by [plane][yye]{:target="_blank"} or [bus][bcbus]{:target="_blank"}, and from there it is necessary to hitch to the Liard River.
...
- [Maps][maps]: Large file containing detailed 1:20,000 scale maps on the NRT route. Made using maps provided by the provincial government of British Columbia.
